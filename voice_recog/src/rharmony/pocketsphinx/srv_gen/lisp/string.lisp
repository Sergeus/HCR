...
(cl:defmethod cl:initialize-instance :after ((m <string-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'string-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pocketsphinx-srv:<string-request> is deprecated: use pocketsphinx-srv:string-request instead.")))

(cl:ensure-generic-function 'msg-val :lambda-list '(m))
(cl:defmethod msg-val ((m <string-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pocketsphinx-srv:msg-val is deprecated.  Use pocketsphinx-srv:msg instead.")
  (msg m))
...
(cl:defmethod cl:initialize-instance :after ((m <string-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'string-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pocketsphinx-srv:<string-response> is deprecated: use pocketsphinx-srv:string-response instead.")))
